                    ...
                    <div className="col s12 m6 l3">
                        <div className="card purple lighten-5">
                            <div className="card-content center-align">
                                ...
                                <h4 className="purple-text">{this.state.estatisticas.totalClientes}</h4>
                    ...
                    <div className="col s12 m6 l3">
                        <div className="card green lighten-5">
                            <div className="card-content center-align">
                                ...
                                <h4 className="green-text">{this.state.estatisticas.clientesNovos}</h4>
                    ...
                    <div className="col s12 m6 l3">
                        <div className="card blue lighten-5">
                            <div className="card-content center-align">
                                ...
                                <h4 className="blue-text">{this.state.estatisticas.clientesAtivos}</h4>
                    ...
                    <div className="col s12 m6 l3">
                        <div className="card orange lighten-5">
                            <div className="card-content center-align">
                                ...
                                <h4 className="orange-text">{this.state.estatisticas.cidadesAtendidas}</h4>
                                ...
                                <div className="center-align" style={{padding: '40px 0'}}>
                                    <div className="row">
                                        <div className="col s2">
                                            <div className={`${this.props.tema} lighten-2`} style={{height: '60px', width: '100%', marginBottom: '10px'}}></div>
                                            <span className="grey-text small">Jan</span>
                                        </div>
                                        <div className="col s2">
                                            <div className={`${this.props.tema} lighten-2`} style={{height: '80px', width: '100%', marginBottom: '10px'}}></div>
                                            <span className="grey-text small">Fev</span>
                                        </div>
                                        <div className="col s2">
                                            <div className={`${this.props.tema} lighten-2`} style={{height: '100px', width: '100%', marginBottom: '10px'}}></div>
                                            <span className="grey-text small">Mar</span>
                                        </div>
                                        <div className="col s2">
                                            <div className={`${this.props.tema} lighten-2`} style={{height: '120px', width: '100%', marginBottom: '10px'}}></div>
                                            <span className="grey-text small">Abr</span>
                                        </div>
                                        <div className="col s2">
                                            <div className={`${this.props.tema} lighten-2`} style={{height: '140px', width: '100%', marginBottom: '10px'}}></div>
                                            <span className="grey-text small">Mai</span>
                                        </div>
                                        <div className="col s2">
                                            <div className={`${this.props.tema}`} style={{height: '160px', width: '100%', marginBottom: '10px'}}></div>
                        ...
                        <div className="card">
                            <div className="card-content">
                                ...
                                <div className="collection">
                                    {this.state.atividadesRecentes.map(atividade => (
                                        <div key={atividade.id} className="collection-item">
                                            <div>
                                                {this.getIconeAtividade(atividade.tipo)}
                            ...
                            <div className="card-action">
                                <a className={`btn waves-effect waves-light ${this.props.tema}`}>
                            ...
                            <div className="card-content">
                                ...
                                <div className="row">
                                    <div className="col s12 m3">
                                        <a className={`btn-large waves-effect waves-light ${this.props.tema} full-width`}>
